...
<body>
    <div class="container py-3">
        <h1>Exercício 18 - Calculadora de juros compostos:</h1>
        <form method="post">
            <div class="mb-3">
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $ValorComposto = $Capital * ((1 + $Juros / 100) ** $Tempo);

            echo "O valor total somado aos juros compostos é de " .number_format($ValorComposto, 2, ',', '.'). " reais";
        }
        ?>
